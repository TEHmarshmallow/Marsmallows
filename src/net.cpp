...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Marsmello " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Marsmellos-com", "dnsseed.Marsmellos.com"},
    {"Marsmellopool.org", "dnsseed.Marsmellopool.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"Marsmellos.com", "testnet-seed.Marsmellos.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Marsmello is probably already running."), addrBind.ToString().c_str());
        else

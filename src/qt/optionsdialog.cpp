    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new MarsmelloUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->MarsmelloAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Marsmello."), QMessageBox::Ok);

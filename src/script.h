...
#ifndef H_Marsmello_SCRIPT
#define H_Marsmello_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMarsmelloAddress
 */
...
public:
    ...
    // Pre-version-0.6, Marsmello always counted CHECKMULTISIGs

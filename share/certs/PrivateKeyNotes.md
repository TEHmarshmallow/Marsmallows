...
unlocked to sign the Marsmello-Qt.app bundle.
...
allowing somebody to distribute a Marsmello-Qt.app or Marsmello-qt-setup.exe with a valid
...
that the Marsmello-qt.exe file inside the installer had not been tampered with.
